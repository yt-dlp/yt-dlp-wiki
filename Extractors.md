...
| Client          | [Cookies](#exporting-youtube-cookies) | [JS runtime](https://github.com/yt-dlp/yt-dlp/wiki/EJS) | [PO tokens](https://github.com/yt-dlp/yt-dlp/wiki/PO-Token-Guide) required for | SABR        | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| --------------- | ------------------------------------- | ------------------------------------------------------- | ------------------------------------------------------------------------------ | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| `web_embedded`  | Supported                             | Required                                                |                                                                                | Supported   | Only available for embeddable videos.                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| `mweb`          | Supported                             | Required                                                | GVS                                                                            | Supported\* | Has "low" and "ultralow" qualities for audio. Overdownloading or random A/B experiments may lead to only SABR formats being returned. Not subject to other clients' throttling when downloading in greater than 10MB chunks; this is useful for quicker downloads when using `--download-sections` or faster seeking within `mpv`'s yt-dlp integration.                                                                                    |
| `tv`            | Required\*                            | Required                                                |                                                                                | Supported\* | Without account cookies, only DRM formats are returned. Note: You can bypass the DRM-only formats _without_ signing in by using guest-session cookies aged for ~1+ days, e.g. `yt-dlp --cookies "guestcookies.txt" "YouTube video URL"` > wait ~1 day > download with `tv` client + aged cookies. Overdownloading or random A/B experiments may lead to only SABR formats being returned.                                                  |
| `tv_downgraded` | Required\*                            | Required                                                |                                                                                | Unsupported | Without account cookies, a "Sign in to confirm you're not a bot" error will appear, even if other clients are not hit with the bot check. Note: If other clients are usable, you can bypass the sign-in requirement by using guest-session cookies aged for ~1+ days, e.g. `yt-dlp --cookies "guestcookies.txt" "YouTube video URL"` > wait ~1 day > download with `tv_downgraded` client + aged cookies.                                  |
| `tv_simply`     | Unsupported                           | Required                                                | GVS                                                                            | Supported   |                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `android`       | Unsupported                           | Unsupported                                             | GVS                                                                            | Only        | There is no PO token plugin that allows PO token generation for this client.                                                                                                                                                                                                                                                                                                                                                               |
| `android_vr`    | Unsupported                           | Unsupported                                             |                                                                                | Supported   | "Made for kids" videos are not available. Poor multi-audio language support.                                                                                                                                                                                                                                                                                                                                                               |
| `ios`           | Unsupported                           | Unsupported                                             | GVS                                                                            | Supported   | There is no PO token plugin that allows PO token generation for this client.                                                                                                                                                                                                                                                                                                                                                               |
