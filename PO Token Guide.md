...
The GVS PO Token is generated differently depending on whether you are using yt-dlp with an account. It can be used across multiple videos. For more information, refer to the [technical details](#technical-details) section.
...
If you are interested, check out the [BgUtils](https://github.com/LuanRT/BgUtils) project which does a deeper dive into the BotGuard attestation process.
